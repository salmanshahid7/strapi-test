...
export declare const FieldInput: import("react").ForwardRefExoticComponent<FieldInputProps & import("react").RefAttributes<HTMLInputElement>>;
export declare const InputWrapper: import("styled-components").StyledComponent<"div", DefaultTheme, Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "ref"> & Pick<import("styled-components").CSSProperties, "cursor" | "display" | "overflow" | "pointerEvents" | "transform" | "position" | "textAlign" | "textTransform" | "zIndex" | "animation" | "transition"> & {
    _hover?: ((theme: DefaultTheme) => string) | undefined;
