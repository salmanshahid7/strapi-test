...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-8pp41Wz_.js"));
        return component;
      }
    });
    app.registerPlugin({
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-Blj4N9Y4.js"));
        return component;
      },
      permissions: PERMISSIONS.main
    });
...
//# sourceMappingURL=index-vcwdSH-G.js.map
